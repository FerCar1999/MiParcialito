...
namespace MiParcialito.Controllers
{
    public class UserTypesController : Controller
    {
        ...
        public UserTypesController(Cg102319Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.UserTypes != null ? 
                          ...
                          Problem("Entity set 'Cg102319Context.UserTypes'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre")] UserType userType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre")] UserType userType)
        {
            if (id != userType.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Cg102319Context.UserTypes'  is null.");
            }
            var userType = await _context.UserTypes.FindAsync(id);
            if (userType != null)
            {
