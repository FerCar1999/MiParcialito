...
namespace MiParcialito.Controllers
{
    public class EstudiantesController : Controller
    {
        ...
        public EstudiantesController(Cg102319Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Estudiantes != null ? 
                          ...
                          Problem("Entity set 'Cg102319Context.Estudiantes'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Nombre,Password,Correo,FechaNacimiento")] Estudiante estudiante)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EstudianteId,Nombre,Password,Correo,FechaNacimiento")] Estudiante estudiante)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Cg102319Context.Estudiantes'  is null.");
            }
            var estudiante = await _context.Estudiantes.FindAsync(id);
            if (estudiante != null)
            {
